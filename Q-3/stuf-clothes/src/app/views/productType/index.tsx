  ...
  return (
    ...
    <div className="py-12 px-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 py-4">
        ...
        {/* ---------------Fourth Image------------- */}
        <div className="bg-cat4 max-h-[10rem] text-white text-center py-4 col-span-2 h-32 w-full">
          <h1 className="text-3xl font-medium ">GET 30% Off</h1>
          <p className="font-semibold">USE PROMO CODE</p>
          <Button className="w-72 text-xl px-2 bg-gray-600/[0.80]">
            DINEWEEKENDSALE
          </Button>
        </div>
      </div>
      ...
      <div className="flex justify-evenly gap-4 py-4">
        ...
        <div>
          <Image src={mainHero} alt="Main Image" height={450} width={465}/>
        </div>
